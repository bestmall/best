...
using System.Linq;
using System.Text;
// Name: 台灣三碼郵遞區號對應程式 (Taiwan 3-digit zip code mapper)
// Author: Johnny Lee 2013
// Version: 1.0.0
//
// 使用方式:
// Address address = new Address() { City: "台北市", Dist: "松山區", Part: "某街某號某樓某室" };
// short? zip = null;
// if (Address.TryParseZipCode(address, out zip))
//    Console.Write(zip);
