...
public class ValidateCode : IHttpHandler, System.Web.SessionState.IRequiresSessionState 
{
    ...
    private string GenerateCheckCode(HttpContext context)
    {
        ...
        //將Cookie改成Session
        //context.Response.Cookies.Add(new HttpCookie("CheckCode", FormsAuthentication.HashPasswordForStoringInConfigFile((checkCode + DateTime.Now.ToString("yyyy/MM/dd")), "MD5")));
