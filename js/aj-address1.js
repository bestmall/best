...
; (function ($) {
    $.fn.ajaddress1 = function (settings) {
        ...
        var _handler = function () {
            ...
            //init
            var container = this;
            var selCountyCount = $(".county1 option", container).length;
            var selCity = $(".city1", container);
            var selCounty = $(".county1", container);
            var zipcode1 = $(".zipcode1", container);
            ...
            selCity.change(function () {
                ...
                //default selected
                if (_settings.county1) {
                    $("option[value=" + _settings.county1 + "]", selCounty).prop('selected', true);
                }
            ...
            //default selected
            if (_settings.city1) {
                $("option[value=" + _settings.city1 + "]", selCity).prop('selected', true);
